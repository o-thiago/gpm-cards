...
export default function CardsPage() {
  ...
  const handleSubmitForm = (formData: { title: string; description: string; image: string }) => {
    if (editingCard) {
  ...
  if (cards.length === 0) {
    return (
      <>
        ...
        <CardForm isOpen={isFormOpen} onClose={handleCloseForm} onSubmit={handleSubmitForm} editingCard={editingCard} />
      </>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <CardGrid cards={cards} onEditCard={handleEditCard} onDeleteCard={handleDeleteCard} />
